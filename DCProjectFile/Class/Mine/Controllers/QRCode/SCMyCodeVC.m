...
@interface SCMyCodeVC ()
@property (nonatomic, strong) UIImageView *backView;
@end

@implementation SCMyCodeVC
...
- (void)UIConfig {
    ...
    [userIcon sd_setImageWithURL:[NSURL URLWithString:[DCUserManager sharedManager].currentUserInfo.portraitUri]];
    
    UILabel *nickName = [[UILabel alloc]init];
    nickName.font = kFontSize(18);
    nickName.textColor = HEX(@"#4B4A53");
    nickName.text = [DCUserManager sharedManager].currentUserInfo.name;
    [nickName sizeToFit];
    ...
    NSDictionary *parms = @{@"appName":kAppName , @"uid":kUser.uid , @"groupId":@"" , @"groupName":@"" , @"type":@(1)};
